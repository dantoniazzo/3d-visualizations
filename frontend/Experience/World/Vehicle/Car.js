 ...
 *
 * The car is generated by blender/export_car.py to these numbers: a body
 * 1.72 wide on X (1.88 over the wheel arches) and 4.5 long on Z, with Z the
 * longitudinal axis and +Z forward — the same convention the heading maths
 * uses. Change one and the other has to follow.
 *
...
const CAPSULE_RADIUS = 0.90;   // body is 1.88 wide over the arches
